...
_lr_productions = [
  ...
  ('programme -> HEADER newline statement newline','programme',4,'p_programme_statement','parser_bash.py',28),
  ('programme -> statement newline','programme',2,'p_programme_statement','parser_bash.py',29),
  ('programme -> HEADER newline statement newline programme','programme',5,'p_programme_recursive','parser_bash.py',39),
  ('programme -> statement newline programme','programme',3,'p_programme_recursive','parser_bash.py',40),
  ('statement -> affectation','statement',1,'p_statement','parser_bash.py',50),
  ('affectation -> SET_VARIABLE = expression','affectation',3,'p_statement_affectation','parser_bash.py',55),
  ('statement -> ECHO expression','statement',2,'p_echo','parser_bash.py',60),
  ('expression -> GET_VARIABLE','expression',1,'p_expression_var','parser_bash.py',65),
  ('expression -> FLOAT','expression',1,'p_expression_val','parser_bash.py',70),
  ('expression -> INT','expression',1,'p_expression_val','parser_bash.py',71),
  ('expression -> STRING','expression',1,'p_expression_val','parser_bash.py',72),
  ('expression -> $ ( ( expression ADD_OP expression ) )','expression',8,'p_expression_op','parser_bash.py',82),
  ('expression -> $ ( ( expression MUL_OP expression ) )','expression',8,'p_expression_op','parser_bash.py',83),
  ('expression -> expression EQ_CMP expression','expression',3,'p_expression_cmp','parser_bash.py',88),
  ('expression -> expression NE_CMP expression','expression',3,'p_expression_cmp','parser_bash.py',89),
  ('expression -> expression LT_CMP expression','expression',3,'p_expression_cmp','parser_bash.py',90),
  ('block -> statement newline','block',2,'p_block','parser_bash.py',95),
  ('block -> statement newline block','block',3,'p_block_recurssive','parser_bash.py',99),
  ('statement -> IF [ expression ] newline THEN newline block FI','statement',9,'p_condition_if','parser_bash.py',104),
  ('statement -> IF [ expression ] newline THEN newline block ELSE newline block FI','statement',12,'p_condition_if_else','parser_bash.py',109),
  ('statement -> WHILE [ expression ] ; DO newline block DONE','statement',9,'p_while','parser_bash.py',113),
  ('statement -> UNTIL [ expression ] ; DO newline block DONE','statement',9,'p_until','parser_bash.py',117),
  ('statement -> FOR SET_VARIABLE IN { INT . . INT } ; DO newline block DONE','statement',14,'p_for','parser_bash.py',121),
]
